...
//Check whether the ray hits the xy plane, and then check if it hits the specific rectangle
...
//Check whether the ray hits the xz plane, and then check if it hits the specific rectangle
...
//Check whether the ray hits the yz plane, and then check if it hits the specific rectangle
